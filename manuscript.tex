...
The novelty lies in the interpretation: we frame incompleteness as arising specifically from the \emph{dimensional mismatch} between oscillatory dynamics and symbolic codes, offering a physical and information-theoretic reading of what is usually treated as a purely logical phenomenon.
...
The framework admits an elegant categorical reformulation.
...
Simulation code is available at [GitHub URL].
